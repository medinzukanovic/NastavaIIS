...
X_pca = pca.transform(X)
ax3.scatter(X_pca[:, 0], X_pca[:, 1], color='red',marker='s', s=100, alpha=0.5)

#povratak na originalne podatke, ali na osnovu transformiranih podataka
X_new = pca.inverse_transform(X_pca)
ax3.scatter(X_new[:, 0], X_new[:, 1], color='green',marker='.', s=100, alpha=0.8)
...
#povratak na originalne podatke, ali na osnovu transformiranih podataka
X_new = pca.inverse_transform(X_pca)
ax5.scatter(X_new[:, 0], X_new[:, 1], color='blue',marker='v', s=100, alpha=0.4)
