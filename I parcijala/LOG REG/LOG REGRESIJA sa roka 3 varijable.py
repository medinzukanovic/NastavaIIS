...
##################
#importovanje fajla
dataset = pd.read_csv(r'C:\Users\HP\Documents\Py Programs\ROK 12.12.2018\User_Data.csv') 
########################
...
test_velicina=0.1  #procentualno 
...
print('---------------------------------------------')
print('Tačnost (procentualno): {:.2f}%'.format(accuracy_score(ytest,y_pred)*100))
print('---------------------------------------------')
######################
