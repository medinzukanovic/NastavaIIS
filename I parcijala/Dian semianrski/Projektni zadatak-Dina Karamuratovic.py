...
def proracun():
    ...
    #procentualno
    procentualno.set(hguk.get()/bruto_pad.get())
    tk.Label(root_novi,text='Procentualan pad:',bg='blue').pack()
    tk.Label(root_novi,text=procentualno.get(),bg='blue').pack()
    #Pad pritiska
